...
# Filename: Stats_Mission6_HUWH.R
# Date last modified: Feb 9, 2026
# Description: Version six of a statistical analysis of the effect of cyclical time on manually verified humpback whale call detections for Mission 6, AKA UVI2_TS_South_20250211.
...
## Reads the manually-annotated humpback detection spreadsheet for Mission 6.
...
mean_deg <- 168.8
mean_x <- mean_deg / 14.2  # 15 degrees per hour, but adjusting for visuals because the rayleigh plot in this code was shifted to put 00:00 at the top of the plot. 14.2 deg to appear as 11:25 a.m.
