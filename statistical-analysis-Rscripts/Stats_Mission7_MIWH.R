...
# Filename: Stats_Mission7_MIWH.R
# Date last modified: Feb 9, 2026
# Description: Version six of a statistical analysis of the effect of cyclical time on manually verified common minke whale call detections for Mission 7, AKA UVI2_AroundSTX_20250306.
...
df <- read.csv("annotated-detection-spreadsheets/Mission7_MIWH.csv", stringsAsFactors = FALSE)
...
mean_deg <- 178.1
mean_x <- mean_deg / 14.43  # 15 degrees per hour, but adjusting for visuals because the rayleigh plot in this code was shifted to put 00:00 at the top of the plot. 14.43 deg to appear as 11:52 a.m.
