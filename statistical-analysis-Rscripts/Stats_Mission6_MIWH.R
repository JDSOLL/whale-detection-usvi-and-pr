...
# Filename: Stats_Mission6_MIWH.R
# Date last modified: Feb 9, 2026
# Description: Version six of a statistical analysis of the effect of cyclical time on manually verified common minke whale call detections for Mission 6, AKA UVI2_TS_South_20250211.
...
df <- read.csv("annotated-detection-spreadsheets/Mission6_MIWH.csv", stringsAsFactors = FALSE)
...
mean_deg <- 188.9
mean_x <- mean_deg / 14.55  # 15 degrees per hour, but adjusting for visuals because the rayleigh plot in this code was shifted to put 00:00 at the top of the plot. 14.55 deg to appear as 12:35 p.m.
